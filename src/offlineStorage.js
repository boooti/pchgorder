...
const INITIAL_EMPLOYEES = [
  { id: 1, code: 'NV001', name: 'Lâm Hoàng Lam', is_active: 1 },
  { id: 2, code: 'NV002', name: 'Vũ Đăng Trình', is_active: 1 },
  { id: 3, code: 'NV003', name: 'Nguyễn Tam Giác', is_active: 1 },
  { id: 4, code: 'NV004', name: 'Trần Trung Tiến', is_active: 1 },
  { id: 5, code: 'NV005', name: 'Trương Vĩnh Thế', is_active: 1 },
  { id: 6, code: 'NV006', name: 'Du Vinh Huê', is_active: 1 },
  { id: 7, code: 'NV007', name: 'Lê Minh Đăng', is_active: 1 },
  { id: 8, code: 'NV008', name: 'Phan Văn Nhân', is_active: 1 },
  { id: 9, code: 'NV009', name: 'Đoàn Tuấn Anh', is_active: 1 },
  { id: 10, code: 'NV010', name: 'Nguyễn Văn Chiến', is_active: 1 },
  { id: 11, code: 'NV011', name: 'Trần Thanh Tiến', is_active: 1 },
  { id: 12, code: 'NV012', name: 'Nguyễn Ngọc Nguyên', is_active: 1 },
  { id: 13, code: 'NV013', name: 'Trần Thị Hương', is_active: 1 },
  { id: 14, code: 'NV014', name: 'Trần Thị Trinh', is_active: 1 },
  { id: 15, code: 'NV015', name: 'Hồ Huy Toàn', is_active: 1 },
  { id: 16, code: 'NV016', name: 'Lê Long Giang', is_active: 1 },
  { id: 17, code: 'NV017', name: 'Thị Yến Linh', is_active: 1 },
  { id: 18, code: 'NV018', name: 'Nguyễn Văn Công', is_active: 1 },
  { id: 19, code: 'NV019', name: 'Trần Văn Nhựt Cường', is_active: 1 },
  { id: 20, code: 'NV020', name: 'Trương Đình Thi', is_active: 1 },
  { id: 21, code: 'NV021', name: 'Trần Văn Sua', is_active: 1 },
  { id: 22, code: 'NV022', name: 'Nguyễn Thị Minh Thư', is_active: 1 },
  { id: 23, code: 'NV023', name: 'Hưng Tấn Đạt', is_active: 1 },
  { id: 24, code: 'NV024', name: 'Nguyễn Hồng Ái', is_active: 1 },
  { id: 25, code: 'NV025', name: 'Đồng Hữu Phú', is_active: 1 },
  { id: 26, code: 'NV026', name: 'Trần Minh Đăng', is_active: 1 },
  { id: 27, code: 'NV027', name: 'Dư Văn Đạt', is_active: 1 },
  { id: 28, code: 'NV028', name: 'Nguyễn Kiều Tiên', is_active: 1 },
  { id: 29, code: 'NV029', name: 'Phạm Bình An', is_active: 1 },
  { id: 30, code: 'NV030', name: 'Huỳnh Tấn Lộc', is_active: 1 },
  { id: 31, code: 'NV031', name: 'Lâm Thiên Phú', is_active: 1 },
  { id: 32, code: 'NV032', name: 'Trần Thị Diễm Linh', is_active: 1 },
  { id: 33, code: 'NV033', name: 'Vũ Huỳnh Như Ý', is_active: 1 },
  { id: 34, code: 'NV034', name: 'Nguyễn Phương Loan', is_active: 1 },
  { id: 35, code: 'NV035', name: 'Trần Chí Hậu', is_active: 1 },
  { id: 36, code: 'NV036', name: 'Trần Võ Phương Nghi', is_active: 1 },
  { id: 37, code: 'NV037', name: 'Trần Thị Nhung', is_active: 1 },
  { id: 38, code: 'NV038', name: 'Đào Thị Huyền Trân', is_active: 1 },
  { id: 39, code: 'NV039', name: 'Nguyễn Tất Vũ', is_active: 1 },
  { id: 40, code: 'NV040', name: 'Nguyễn Thị Kim Yến', is_active: 1 }
];
